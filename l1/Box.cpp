...
void threadFunction(PhysicsThread& physClass) {

		physClass.Calculations(/*cr, cdr, cddr, cdt*/);
...
Box::Box(Graphics& gfx,
	...
	std::thread thr(threadFunction, std::ref(PhysClass));
	thr.detach();
